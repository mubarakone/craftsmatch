    ...
    <footer className="border-t bg-background">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Connecting skilled craftsmen with builders for quality artisanal materials.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/marketplace/categories" className="text-sm text-muted-foreground hover:text-primary">
                  Categories
                </Link>
              </li>
              <li>
                <Link href="/marketplace/featured" className="text-sm text-muted-foreground hover:text-primary">
                  Featured Items
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} CraftsMatch. All rights reserved.
          </p>
